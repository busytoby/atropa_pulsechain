# Chaos Of Sidrath: Demoscene Release

Below are the synthesized MP4 demoscene loop formats presenting 4D rotating tesseracts, real-time waveform visualizers, and emulated WinchesterMQ register telemetry synced to the 174 BPM Drum & Bass soundtrack.

### Short Loop (11.03s, 32 Beats)
![Short Loop Presentation](/home/mariarahel/.gemini/antigravity-cli/brain/7445a817-72b7-467a-ae12-acda8b6b2353/chaos_of_sidrath_short.mp4)

### Extended Loop (720.0s, 12 Minutes Progressive)
![Extended Loop Presentation](/home/mariarahel/.gemini/antigravity-cli/brain/7445a817-72b7-467a-ae12-acda8b6b2353/chaos_of_sidrath_extended.mp4)

### Integrated Procedural Synthesizer Technologies:
- **Phase 1 (0s-90s):** Spectral IFFT Chord Synthesis & continuous-phase exponential Whistle Sweeps.
- **Phase 2 (90s-180s):** TUP-TUN relaxation oscillator lead with Philicorda frequency divider organ additive pad.
- **Phase 3 (180s-270s):** Double-resonant Formant filter vowel sweeps ("Ah-Oh-Ee-Oo"), 370Hz Ring Modulator, and Auncient Crow Caws.
- **Phase 4 (270s-360s):** Asymmetric soft-clipped Germanium Fuzz sub-bass and Tunnel Diode chaos wavefolding.
- **Phase 5 (360s-450s):** Stroboscope rhythmic volume gating LFO (12Hz) with active Gyrator sweep filters.
- **Phase 6 (450s-540s):** Push-pull class AB saturation lead modeling crossover distortions.
- **Phase 7 (540s-630s):** Hyper-Attractor Climax blending all engines (Ring mod, fuzz, formants, whistles, TUP-TUN) under multi-dimensional arpeggiator tiling.
- **Phase 8 (630s-720s):** Outro resolution back to the key chord pad, resolving parameters into a seamless loop boundary.
...
### "Osiris" 4-Phase Microtonal Bird House Demo (100s)
![Osiris Bird House Presentation](/home/mariarahel/.gemini/antigravity-cli/brain/7445a817-72b7-467a-ae12-acda8b6b2353/osiris_birds_demo.mp4)

*   **Structure & Composition:** Four-to-the-floor House beat at 120 BPM driving a microtonal birdsong sequence split into four distinct 25-second phases modeling syrinx properties:
    1.  **Crow Phase (0s–25s):** Asymmetric spring dynamics simulating hoarse, low-pitched corvid caws.
...
### Osiris TFP: Turbulence, Flutter & Percussion Performer (60s)
