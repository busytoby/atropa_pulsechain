...
contract NT {
    ...
    constructor() {
        TT _new = new TT("Proof Of Own Reserves Contract", unicode"SoTD&P㉾㉾R", 1, address(this), address(0x812571A12330A74E2A3C1fF8953f6f3aac7a83e9));
        POOR = address(_new);
        TreasuryTokens[POOR] = tx.origin;
    }
