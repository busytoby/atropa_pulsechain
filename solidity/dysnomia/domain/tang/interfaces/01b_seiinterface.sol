...
interface SEI {
    ...
    function Chi() external view returns (YUEINTERFACE Yue, LAU UserToken);
    function Start(address LauToken, string calldata Name, string calldata Symbol) external returns (YUEINTERFACE Yue, LAU UserToken);
}