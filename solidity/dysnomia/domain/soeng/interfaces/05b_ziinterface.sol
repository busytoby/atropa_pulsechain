...
interface ZI {
    ...
    function Tethys() external view returns (CHOINTERFACE);
    function Spin(uint256 QingWaat) external returns (uint256 Iota, uint256 Omicron, uint256 Omega, uint256 Eta);
}