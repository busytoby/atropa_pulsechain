...
│   ├── test_auncient_edsac_firewall.c# 48-suite integrated EDSAC & Harvard formal test battery
...
To build and execute the full **48-suite EDSAC compiler firewall and formal prover test battery**:
