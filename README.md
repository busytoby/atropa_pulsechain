...
│   │   ├── auncient_harvard_computation_lab.c # Harvard Mark I wheels, tape latch, Bessel, Legendre, Orbit, Multiplier, Interpolator, Biquinary, Divider, Geneva
...
│   ├── test_auncient_edsac_firewall.c# 31-suite integrated EDSAC & Harvard formal test battery
...
To build and execute the full **31-suite EDSAC compiler firewall and formal prover test battery**:
