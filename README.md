...
│   ├── test_auncient_edsac_firewall.c# 44-suite integrated EDSAC & Harvard formal test battery
...
To build and execute the full **44-suite EDSAC compiler firewall and formal prover test battery**:
