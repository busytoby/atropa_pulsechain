...
│   ├── test_auncient_edsac_firewall.c# 47-suite integrated EDSAC & Harvard formal test battery
...
To build and execute the full **47-suite EDSAC compiler firewall and formal prover test battery**:
