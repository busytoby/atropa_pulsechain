...
│   │   ├── auncient_harvard_computation_lab.c # Harvard Mark I wheels, tape latch, Bessel, Legendre, Orbit, Multiplier, Interpolator, Biquinary, Divider, Geneva, Zuo H-Bridge, Tape Sync, Plugboard, Hankel, Self-Identity, Torque Balance, Modified Bessel
...
│   ├── test_auncient_edsac_firewall.c# 38-suite integrated EDSAC & Harvard formal test battery
...
To build and execute the full **38-suite EDSAC compiler firewall and formal prover test battery**:
