...
function synthesizeSequence(phonemeSequence, params, sampleRate = 44100) {
    ...
    for (let idx = 0; idx < phonemeSequence.length; idx++) {
        ...
        for (let s = 0; s < numSamplesSound; s++) {
            ...
            const pitchInst = pitchTarget > 0 ? declination + (pitchTarget - 120.0) : 0.0;
...
const params = {
    ...
    f1: {
        ...
        'P': 300.0, 'U': 500.0, 'S': 0.0, 'SH': 0.0, 'CH': 400.0, 'A': 480.0, 'N': 250.0,
        'DH': 300.0, 'I': 400.0, 'Z': 0.0, 'T': 0.0, 'M': 280.0, 'G': 300.0, 'B': 300.0,
        'R': 310.0, 'F': 0.0
    },
    f2: {
        'H': 1500.0, 'E': 1800.0, 'L': 1000.0, 'O': 900.0,
        'W': 800.0, 'ER': 1150.0, 'LD': 850.0, 'D': 1500.0,
        'P': 900.0, 'U': 1500.0, 'S': 0.0, 'SH': 0.0, 'CH': 2000.0, 'A': 1900.0, 'N': 1000.0,
        'DH': 1300.0, 'I': 2000.0, 'Z': 0.0, 'T': 0.0, 'M': 900.0, 'G': 1500.0, 'B': 900.0,
        'R': 1050.0, 'F': 0.0
    },
    f3: {
        'H': 2500.0, 'E': 2500.0, 'L': 2500.0, 'O': 2400.0,
        'W': 2400.0, 'ER': 1500.0, 'LD': 2400.0, 'D': 2500.0,
        'P': 2400.0, 'U': 2500.0, 'S': 0.0, 'SH': 0.0, 'CH': 3000.0, 'A': 2500.0, 'N': 2500.0,
        'DH': 2200.0, 'I': 2500.0, 'Z': 0.0, 'T': 0.0, 'M': 2400.0, 'G': 2500.0, 'B': 2400.0,
        'R': 1500.0, 'F': 0.0
    },
    pitch: {
...
const wordDict = {
    ...
    "IS": ['I', 'Z'],
    "THE": ['DH', 'U'],
    "DYSNOMIA": ['D', 'I', 'S', 'N', 'O', 'M', 'E', 'A'],
    "SYNTHESIZER": ['S', 'I', 'N', 'DH', 'U', 'S', 'I', 'Z', 'ER'],
    "OH": ['O'],
