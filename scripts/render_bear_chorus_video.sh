...
gcc -Wall -Wextra -Werror -std=c11 -O3 -Iinclude -Itsfi2-deepseek/inc src/auncient_bear_chorus.c src/auncient_teddy_personality.c tsfi2-deepseek/src/tsfi_cade_imf_nato.c tsfi2-deepseek/src/tsfi_displacementshader.c -o src/auncient_bear_chorus -lm -lrt
