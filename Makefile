...
test-timesampleinterpolation:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -Iinc -Itsfi2-deepseek/inc tests/test_timesampleinterpolation.c tsfi2-deepseek/src/tsfi_timesampleinterpolation.c -o tests/test_timesampleinterpolation -lm -lrt
	./tests/test_timesampleinterpolation
	@rm -f tests/test_timesampleinterpolation
