...
test-hathitrust-extra-final:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Iinc tests/test_hathitrust_extra_final.c src/hathitrust_mets_range.c src/hathitrust_solr_facet.c src/hathitrust_hathifile_diff.c -o tests/test_hathitrust_extra_final -lrt
	./tests/test_hathitrust_extra_final
	@rm -f tests/test_hathitrust_extra_final

test-hathitrust-bib-oauth:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Iinc tests/test_hathitrust_bib_oauth.c src/hathitrust_oauth_callback.c src/hathitrust_bibframe.c -o tests/test_hathitrust_bib_oauth -lrt
	./tests/test_hathitrust_bib_oauth
	@rm -f tests/test_hathitrust_bib_oauth

test-tsfi2-compiler-bin:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Iinc tests/test_tsfi2_compiler_bin.c src/tsfi2_compiler_bin.c -o tests/test_tsfi2_compiler_bin -lrt
...
test-tsfi2-compiler-standards:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Iinc tests/test_tsfi2_compiler_standards.c src/tsfi2_compiler.c -o tests/test_tsfi2_compiler_standards -lrt
...
tsv_format_converter:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Iinc -Itsfi2-deepseek/inc src/tsv_format_converter.c tsfi2-deepseek/src/tsfi_quadtree_ksds.c tsfi2-deepseek/src/tsfi_mainframe_ebcdic.c scripts/libantigravity_extra.c scripts/libantigravity_interop.c scripts/abi_dispatch_map.c -o tsv_format_converter -lm -lrt
...
test-teddy-loader:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -Iinc -Itsfi2-deepseek/inc -Itests tests/test_auncient_teddy_loader.c -o tests/test_auncient_teddy_loader -lm -lrt
...
test-auncient-teddy-personality:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -Iinclude tests/test_auncient_teddy_personality.c src/auncient_teddy_personality.c -o tests/test_auncient_teddy_personality -lrt
