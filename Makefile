...
test-bboxcache:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -Iinc -Itsfi2-deepseek/inc tests/test_bboxcache.c tsfi2-deepseek/src/tsfi_bboxcache.c -o tests/test_bboxcache -lm -lrt
	./tests/test_bboxcache
	@rm -f tests/test_bboxcache
