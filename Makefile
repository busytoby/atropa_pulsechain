...
test-hathitrust-lore:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Itsfi2-deepseek -Itsfi2-deepseek/inc tests/test_hathitrust_lore.c src/hathitrust_mets.c src/hathitrust_rib.c src/hathitrust_osl.c src/hathitrust_hathifile.c -o tests/test_hathitrust_lore -lrt
...
test-hathitrust-final-extra:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Itsfi2-deepseek -Itsfi2-deepseek/inc src/hathitrust_cli.c src/hathitrust_hathifile_search.c src/hathitrust_hathifile.c src/hathitrust_cache_profiler.c src/hathitrust_cache.c -o tests/hathitrust_cli -lrt
...
test-tsfi2-compiler-standards:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -I. -Itsfi2-deepseek -Itsfi2-deepseek/inc tests/test_tsfi2_compiler_standards.c src/tsfi2_compiler.c -o tests/test_tsfi2_compiler_standards -lrt
