...
test-subdivinterpolateboundary:
	gcc -Wall -Wextra -Werror -std=c11 -O3 -Iinc -Itsfi2-deepseek/inc tests/test_subdivinterpolateboundary.c tsfi2-deepseek/src/tsfi_subdivinterpolateboundary.c -o tests/test_subdivinterpolateboundary -lm -lrt
	./tests/test_subdivinterpolateboundary
	@rm -f tests/test_subdivinterpolateboundary
