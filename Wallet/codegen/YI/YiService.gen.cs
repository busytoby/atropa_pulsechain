...
using Dysnomia.Contracts.YI.ContractDefinition;

namespace Dysnomia.Contracts.YI
{
    public partial class YiService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, YiDeployment yiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<YiDeployment>().SendRequestAndWaitForReceiptAsync(yiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, YiDeployment yiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<YiDeployment>().SendRequestAsync(yiDeployment);
        }

        public static async Task<YiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, YiDeployment yiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, yiDeployment, cancellationTokenSource);
            return new YiService(web3, receipt.ContractAddress);
        }

        public YiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }

        public Task<BangOutputDTO> BangQueryAsync(BangFunction bangFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryDeserializingToObjectAsync<BangFunction, BangOutputDTO>(bangFunction, blockParameter);
        }

        public Task<BangOutputDTO> BangQueryAsync(string a, BlockParameter blockParameter = null)
        {
            var bangFunction = new BangFunction();
                bangFunction.A = a;
            
            return ContractHandler.QueryDeserializingToObjectAsync<BangFunction, BangOutputDTO>(bangFunction, blockParameter);
        }

        public Task<string> BetaRequestAsync(BetaFunction betaFunction)
        {
             return ContractHandler.SendRequestAsync(betaFunction);
        }

        public Task<TransactionReceipt> BetaRequestAndWaitForReceiptAsync(BetaFunction betaFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(betaFunction, cancellationToken);
        }

        public Task<string> BetaRequestAsync(string name, string symbol)
        {
            var betaFunction = new BetaFunction();
                betaFunction.Name = name;
                betaFunction.Symbol = symbol;
            
             return ContractHandler.SendRequestAsync(betaFunction);
        }

        public Task<TransactionReceipt> BetaRequestAndWaitForReceiptAsync(string name, string symbol, CancellationTokenSource cancellationToken = null)
        {
            var betaFunction = new BetaFunction();
                betaFunction.Name = name;
                betaFunction.Symbol = symbol;
        ...
        public Task<string> BingRequestAsync(BingFunction bingFunction)
        {
             return ContractHandler.SendRequestAsync(bingFunction);
        }

        public Task<TransactionReceipt> BingRequestAndWaitForReceiptAsync(BingFunction bingFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(bingFunction, cancellationToken);
        }

        public Task<string> BingRequestAsync(Bao b)
        {
            var bingFunction = new BingFunction();
                bingFunction.B = b;
            
             return ContractHandler.SendRequestAsync(bingFunction);
        }

        public Task<TransactionReceipt> BingRequestAndWaitForReceiptAsync(Bao b, CancellationTokenSource cancellationToken = null)
        {
            var bingFunction = new BingFunction();
                bingFunction.B = b;
        ...
        public Task<string> KappaRequestAsync(KappaFunction kappaFunction)
        {
             return ContractHandler.SendRequestAsync(kappaFunction);
        }

        public Task<TransactionReceipt> KappaRequestAndWaitForReceiptAsync(KappaFunction kappaFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(kappaFunction, cancellationToken);
        }

        public Task<string> KappaRequestAsync(string rod, string cone)
        {
            var kappaFunction = new KappaFunction();
                kappaFunction.Rod = rod;
                kappaFunction.Cone = cone;
            
             return ContractHandler.SendRequestAsync(kappaFunction);
        }

        public Task<TransactionReceipt> KappaRequestAndWaitForReceiptAsync(string rod, string cone, CancellationTokenSource cancellationToken = null)
        {
            var kappaFunction = new KappaFunction();
                kappaFunction.Rod = rod;
                kappaFunction.Cone = cone;
        ...
        public Task<string> PsiQueryAsync(PsiFunction psiFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<PsiFunction, string>(psiFunction, blockParameter);
        }

        
        public Task<string> PsiQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<PsiFunction, string>(null, blockParameter);
        }
        ...
        public Task<string> ReactRequestAsync(Bao gamma, ulong pi)
        {
            var reactFunction = new ReactFunction();
                reactFunction.Gamma = gamma;
                reactFunction.Pi = pi;
            
             return ContractHandler.SendRequestAsync(reactFunction);
        }

        public Task<TransactionReceipt> ReactRequestAndWaitForReceiptAsync(Bao gamma, ulong pi, CancellationTokenSource cancellationToken = null)
        {
            var reactFunction = new ReactFunction();
                reactFunction.Gamma = gamma;
                reactFunction.Pi = pi;
        ...
        public Task<ulong> RingQueryAsync(RingFunction ringFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<RingFunction, ulong>(ringFunction, blockParameter);
        }

        
        public Task<ulong> RingQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<RingFunction, ulong>(null, blockParameter);
        }

        public Task<string> SHAFactoryInterfaceQueryAsync(SHAFactoryInterfaceFunction sHAFactoryInterfaceFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<SHAFactoryInterfaceFunction, string>(sHAFactoryInterfaceFunction, blockParameter);
        }

        
        public Task<string> SHAFactoryInterfaceQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<SHAFactoryInterfaceFunction, string>(null, blockParameter);
        }

        public Task<string> SHIOFactoryInterfaceQueryAsync(SHIOFactoryInterfaceFunction sHIOFactoryInterfaceFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<SHIOFactoryInterfaceFunction, string>(sHIOFactoryInterfaceFunction, blockParameter);
        }

        
        public Task<string> SHIOFactoryInterfaceQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<SHIOFactoryInterfaceFunction, string>(null, blockParameter);
        }
        ...
        public Task<ulong> XiQueryAsync(XiFunction xiFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<XiFunction, ulong>(xiFunction, blockParameter);
        }

        
        public Task<ulong> XiQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<XiFunction, ulong>(null, blockParameter);
        }
        ...
        public override List<Type> GetAllFunctionTypes()
        {
            return new List<Type>
            {
                ...
                typeof(RingFunction),
                typeof(SHAFactoryInterfaceFunction),
                typeof(SHIOFactoryInterfaceFunction),
                typeof(TypeFunction),
                typeof(XiFunction),
                typeof(XiaoFunction),
