...
using Dysnomia.Contracts.domain.soeng.XIA.ContractDefinition;

namespace Dysnomia.Contracts.domain.soeng.XIA
{
    public partial class XiaService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, XiaDeployment xiaDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<XiaDeployment>().SendRequestAndWaitForReceiptAsync(xiaDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, XiaDeployment xiaDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<XiaDeployment>().SendRequestAsync(xiaDeployment);
        }

        public static async Task<XiaService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, XiaDeployment xiaDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, xiaDeployment, cancellationTokenSource);
            return new XiaService(web3, receipt.ContractAddress);
        }

        public XiaService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
        ...
        public Task<string> ChargeRequestAsync(BigInteger qingWaat)
        {
            var chargeFunction = new ChargeFunction();
                chargeFunction.QingWaat = qingWaat;
            
             return ContractHandler.SendRequestAsync(chargeFunction);
        }

        public Task<TransactionReceipt> ChargeRequestAndWaitForReceiptAsync(BigInteger qingWaat, CancellationTokenSource cancellationToken = null)
        {
            var chargeFunction = new ChargeFunction();
                chargeFunction.QingWaat = qingWaat;
        ...
        public Task<string> FomalhauteQueryAsync(FomalhauteFunction fomalhauteFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<FomalhauteFunction, string>(fomalhauteFunction, blockParameter);
        }

        
        public Task<string> FomalhauteQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<FomalhauteFunction, string>(null, blockParameter);
        }
        ...
        public Task<string> MaiQueryAsync(MaiFunction maiFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<MaiFunction, string>(maiFunction, blockParameter);
        }

        
        public Task<string> MaiQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<MaiFunction, string>(null, blockParameter);
        }
        ...
        public override List<Type> GetAllFunctionTypes()
        {
            ...
            {
                typeof(ChargeFunction),
                typeof(FomalhauteFunction),
