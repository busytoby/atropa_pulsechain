...
using Dysnomia.Contracts.domain.soeng.QI.ContractDefinition;

namespace Dysnomia.Contracts.domain.soeng.QI
{
    public partial class QiService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, QiDeployment qiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<QiDeployment>().SendRequestAndWaitForReceiptAsync(qiDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, QiDeployment qiDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<QiDeployment>().SendRequestAsync(qiDeployment);
        }

        public static async Task<QiService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, QiDeployment qiDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, qiDeployment, cancellationTokenSource);
            return new QiService(web3, receipt.ContractAddress);
        }

        public QiService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }

        public Task<string> ErisQueryAsync(ErisFunction erisFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ErisFunction, string>(erisFunction, blockParameter);
        }

        
        public Task<string> ErisQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ErisFunction, string>(null, blockParameter);
        }
        ...
        public Task<string> ReactSoulRequestAsync(ReactSoulFunction reactSoulFunction)
        {
             return ContractHandler.SendRequestAsync(reactSoulFunction);
        }

        public Task<TransactionReceipt> ReactSoulRequestAndWaitForReceiptAsync(ReactSoulFunction reactSoulFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(reactSoulFunction, cancellationToken);
        }

        public Task<string> ReactSoulRequestAsync(ulong soul)
        {
            var reactSoulFunction = new ReactSoulFunction();
                reactSoulFunction.Soul = soul;
            
             return ContractHandler.SendRequestAsync(reactSoulFunction);
        }

        public Task<TransactionReceipt> ReactSoulRequestAndWaitForReceiptAsync(ulong soul, CancellationTokenSource cancellationToken = null)
        {
            var reactSoulFunction = new ReactSoulFunction();
                reactSoulFunction.Soul = soul;
        ...
        public Task<BigInteger> ReactWaatQueryAsync(ReactWaatFunction reactWaatFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ReactWaatFunction, BigInteger>(reactWaatFunction, blockParameter);
        }

        
        public Task<BigInteger> ReactWaatQueryAsync(BigInteger waat, BlockParameter blockParameter = null)
        {
            var reactWaatFunction = new ReactWaatFunction();
                reactWaatFunction.Waat = waat;
        ...
        public Task<string> ZuoQueryAsync(ZuoFunction zuoFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ZuoFunction, string>(zuoFunction, blockParameter);
        }

        
        public Task<string> ZuoQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ZuoFunction, string>(null, blockParameter);
        }
        ...
        public override List<Type> GetAllFunctionTypes()
        {
            return new List<Type>
            {
                ...
                typeof(ReactSoulFunction),
                typeof(ReactWaatFunction),
