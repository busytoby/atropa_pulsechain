...
Requirements:
1. Git post-commit Hook Script: The script must hook into local git lifecycle and trigger automatically after a commit. It must navigate to the deepseek directory, build `test_vulkan_teddy_bear`, and execute `run_benchmarks.sh`.
