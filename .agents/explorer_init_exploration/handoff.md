...
## 2. Logic Chain
1. `bin/test_vulkan_teddy_bear` is compiled via `make bin/test_vulkan_teddy_bear` inside `/home/mariarahel/src/tsfi2/atropa_pulsechain/tsfi2-deepseek`.
2. Running `./bin/test_vulkan_teddy_bear --benchmark` generates the performance metrics inside `/home/mariarahel/src/tsfi2/atropa_pulsechain/tsfi2-deepseek/benchmarks/profiler_suite/benchmark_results.json`.
...
2. Check that the paths to `test_vulkan_teddy_bear.c`, `run_benchmarks.sh`, and `generate_report.py` are correct.
