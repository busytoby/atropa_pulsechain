...
| 172 | NBS FIPS PUB 19-2 Data Code Dictionary Validator | PASS | Data Code Validator | Volume 24 |
| 173 | NBS FIPS 140-3 Cryptographic AES/SHA-256 | PASS | AES-256 & SHA-256 loops | Volume 24 |
| 174 | NBS FIPS 201-3 PIV Authentication | PASS | PIV card verification | Volume 24 |
| 175 | NBS FIPS 140-3 Known Answer Tests (KAT) | PASS | Startup Known Answer Tests | Volume 24 |
| 176 | NBS FIPS 140-3 Key Zeroization | PASS | Volatile memory zeroization | Volume 24 |
| 177 | NBS FIPS 140-3 Hash-DRBG Generation | PASS | Deterministic random bit generator | Volume 24 |
| 178 | NBS FIPS 140-3 ECDH Key Agreement | PASS | Elliptic Curve DH agreement | Volume 24 |
| 179 | NBS FIPS 186-5 ECDSA Signatures | PASS | ECDSA P-256 signatures | Volume 24 |
| 180 | NBS FIPS 140-3 Role-Based Access Control | PASS | CO & User role boundaries | Volume 24 |
| 181 | NBS FIPS 140-3 Approved Mode Indicator | PASS | Approved mode queries | Volume 24 |
| 182 | NBS FIPS 140-3 Virtual Tamper Auto-Zero | PASS | Auto-zeroization on tamper | Volume 24 |
| 183 | NBS FIPS 140-3 AES Key Wrapping | PASS | AES KWP key protection | Volume 24 |
| 184 | NBS FIPS 140-3 Firmware Integrity | PASS | HMAC-SHA-256 image validation | Volume 24 |
| 185 | NBS FIPS 140-3 Plaintext Bypass Control | PASS | Plaintext bypass transition | Volume 24 |
| 186 | NBS FIPS 140-3 Split-Key Entry | PASS | Split master key entry | Volume 24 |
| 187 | NBS FIPS 140-3 Subsystem Error Gating | PASS | Subsystem error lockouts | Volume 24 |
| 188 | NBS FIPS 140-3 Key Policy & Use Limits | PASS | Policy and use limit checks | Volume 24 |
| 189 | NBS FIPS 46-3 Triple-DES | PASS | Triple-DES ECB encrypt/decrypt | Volume 24 |
| 190 | NBS FIPS 74 Key Distribution Center | PASS | Wrapped session key distribution | Volume 24 |
| 191 | NBS FIPS 140-3 Power-Up Self-Tests | PASS | Boot self-test diagnostics | Volume 24 |
| 192 | NBS FIPS 197 AES-256 CBC Mode | PASS | AES-256 CBC with IVs | Volume 24 |
| 193 | NBS FIPS 180-4 SHA-512 Secure Hash | PASS | 512-bit secure message hashing | Volume 24 |
| 194 | NBS FIPS 87 Automated ADP Failover | PASS | Contingency hot standby failover | Volume 24 |
| 195 | NBS FIPS 88 System Integrity Checksums | PASS | CRC32 database integrity | Volume 24 |
| 196 | NBS FIPS 102 Accreditation Certificate | PASS | ECDSA accreditation signing | Volume 24 |
| 197 | NBS FIPS 198-1 HMAC Message Auth Code | PASS | HMAC-SHA-256 authentications | Volume 24 |
| 198 | DECnet Phase II Distributed Routing | PASS | Dynamic node cost-vector routes | Volume 24 |
| 199 | IBM SDLC Frame Transceiver | PASS | SDLC serial frame FCS recovery | Volume 24 |
| 200 | DECnet-over-SDLC Router Bridge | PASS | Dynamic updates over SDLC hub | Volume 24 |
| 201 | SDLC SNRM/UA Link Handshake | PASS | Connection handshake state tracking | Volume 24 |
| 202 | SDLC Sliding Window Sequence Tracker | PASS | Modulo-8 window tracking limits | Volume 24 |
| 203 | Primary Polling Round-Robin Scheduler | PASS | Sequential station address polling | Volume 24 |
| 204 | SDLC Frame Reject (FRMR) Signaling | PASS | Diagnostic protocol error signaling | Volume 24 |
| 205 | SDLC Retransmission T1 Timer | PASS | Frame timeout retransmits tracking | Volume 24 |
| 206 | SDLC Half-Duplex Line Turnaround | PASS | Tx/Rx link-level mode handshakes | Volume 24 |
| 207 | DECnet NSP Logical Link Handshake | PASS | Connect/Accept link session handshakes | Volume 24 |
| 208 | SDLC Broadcast Station Addressing | PASS | Group and broadcast address delivery | Volume 24 |
| 209 | DECnet Node Name Directory Resolver | PASS | Resolve node names to node IDs | Volume 24 |
| 210 | SDLC Supervisory Flow Control | PASS | Busy signaling via RR/RNR updates | Volume 24 |
| 211 | DECnet Multi-Hop Forwarding Engine | PASS | Dynamic packet transit routing | Volume 24 |
| 212 | DECnet Keep-Alive Hello Protocol | PASS | Periodic neighbor node discovery | Volume 24 |
| 213 | DECnet Routing Header Serialization | PASS | Layer-3 packet headers codecs | Volume 24 |
| 214 | SDLC Frame Retransmission Queue | PASS | Buffer sent frames for retry checks | Volume 24 |
