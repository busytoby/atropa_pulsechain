...
int main(void) {
    ...
    // 27. Test Centrex Multicultural Unicode Dial alias resolution
    ...
    blue_box_centrex_add_unicode_alias("救急", 808);
    assert(blue_box_centrex_resolve_unicode_route("救急") == 808);
