...
bool tsfi_xplos_shell_xdc(const char *cmd) {
    ...
    // Check for "cbtxdcstatsstatusdetailsprogress" command
    if (strcmp(cmd, "cbtxdcstatsstatusdetailsprogress") == 0) {
        printf("\n");
        printf("================================================================================\n");
        printf("                  DEBUGGER XDC COMPLIANCE AUDIT PROGRESS                        \n");
        printf("================================================================================\n");
    ...
    // Check for "cbtxdcignorelistreset" command
    if (strcmp(cmd, "cbtxdcignorelistreset") == 0) {
        printf("[XDC] Debugger ignore/exclude configurations reset to default baseline\n");
        printf("  - Active exclusions cleared. RC=0000\n");
        return true;
    }

    // Check for "cbtxdcignorelistresetstat" command
    if (strcmp(cmd, "cbtxdcignorelistresetstat") == 0) {
        printf("\n");
        printf("================================================================================\n");
        printf("                  DEBUGGER XDC IGNORE LIST RESETS STATISTICS                    \n");
        printf("================================================================================\n");
