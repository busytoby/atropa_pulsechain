...
void tsfi_spider_fill_crow_tastes(const char *cache_path) {
    ...
    quoth.msaa_sample_count = 1;  // Deterministic beak motion doesn't need MSAA
    ...
    sick.msaa_sample_count = 4;  // Sickness needs 4x MSAA for subjective softness
    ...
    flight.msaa_sample_count = 4;  // Flight motion needs MSAA to avoid shimmering
