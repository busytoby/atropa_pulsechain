...
bool auncient_leed_platinum_verify_theorems_46_50(LeedPlatinumEvaluationState *state, const TeddyBearHeartUsdaAsset *teddy) {
    ...
    state->pmv_comfort_value = teddy->heart.thermal_comfort_pmv;
    ...
    state->zone_co2_differential_ppm = teddy->co2_ppm - 400.0f; /* Ambient baseline 400 ppm */
