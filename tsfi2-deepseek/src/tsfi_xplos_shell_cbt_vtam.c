...
static bool handle_vtamroutereccountlimitsreset(void) {
    printf("[VTAM] Gateway route recovery threshold error limits reset back to standard baseline parameters\n");
    printf("  - Threshold limits reset completed. RC=0000\n");
    return true;
}
...
static bool handle_vtamroutereccountlimitsresetstats(void) {
    printf("\n");
    printf("================================================================================\n");
    printf("                  VTAM GATEWAY LIMITS RESET LOGS HISTORY                        \n");
    printf("================================================================================\n");
...
bool tsfi_xplos_shell_cbt_vtam(const char *cmd) {
    ...
    if (strcmp(cmd, "vtamroutereccountlimitsresetstats") == 0) return handle_vtamroutereccountlimitsresetstats();
