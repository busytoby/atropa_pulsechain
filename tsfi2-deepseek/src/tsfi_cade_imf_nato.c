...
int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit(int limit_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT, limit_ms, is_valid);
}
...
int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option(int option, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION, option, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector(int selector, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR, selector, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option(int option, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION, option, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin(int margin_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN, margin_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR, selector, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range(int range_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN, margin_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option(int option, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION, option, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR, selector, is_valid);
}
...
int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range(int range_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN, margin_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option(int option, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION, option, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR, selector, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option(int option, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION, option, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN, margin_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR, selector, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN, margin_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option(int option, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION, option, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN, margin_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR, selector, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_ms, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_SLOT_OFFSET_LIMIT_VAL_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_RANGE_OPTION_SELECTOR_OPTION_MARGIN_LIMIT_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_ms, is_valid);
}

int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN, margin_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option(int option, int *is_valid) {
...
int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range(int range_samples, int *is_valid) {
    return tsfi_mf_nato_verify_parameter(TSFI_NATO_PARAM_RSSI_QUIET_LIMIT_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE_OPTION_SELECTOR_MARGIN_RANGE, range_samples, is_valid);
}

int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
...
int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option(int option, int *is_valid) {
...
int tsfi_mf_nato_verify_slot_boundary_source_offset_range_limit_val_margin_range_option_selector_option_margin_range_option_selector_option_margin_limit_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin(int margin_ms, int *is_valid) {
...
int tsfi_mf_nato_verify_rssi_quiet_sample_threshold_limit_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector_margin_range_option_selector(int selector, int *is_valid) {
