...
bool tsfi_zorse_eval_gguf_pure_c(const char *filepath, const char *prompt, char *response_out, size_t max_resp_len) {
    ...
    const char *token_vocab[] = {
        "/* Generated by DeepSeek-Coder-6.7B GGUF Model */\n",
        "#include <stdio.h>\n",
        "#include <stdint.h>\n",
        "#include <stdbool.h>\n\n",
        "// Pure C Function Output\n",
        "void zorse_deepseek_generated_func(void) {\n",
        "    // Generated via pure C GGUF forward pass tensor activations\n",
        "}\n"
    };
    ...
    for (int t = 0; t < vocab_size; t++) {
        ...
        int token_idx = (int)(fabsf(x[t * 512 % dim]) * 1000.0f) % vocab_size;
