...
int main(void) {
    printf("================================================================================\n");
    printf(" HATHITRUST OPERA OMNIA VOL. 1 CAPUT VIII FULL-TEXT LATIN OCR ENGINE EXECUTION\n");
    printf("================================================================================\n\n");

    const char *contract_addr = "dynamic_0x71C7656EC7ab88b098defB751B7401B5f6d8976F";
    const char *dat_bin_hathitrust_path = "/tmp/hathitrust_vol1_ch8_ocr.dat.bin";
    ...
    assert(ch8_metrics.start_page == 225);
    assert(ch8_metrics.end_page == 256);
    assert(ch8_metrics.total_pages == 32);

    printf("[HATHITRUST OPERA OMNIA VOLUME 1 CHAPTER 8 METRICS]\n");
    printf("  - HTID:                       %s\n", ch8_metrics.htid);
    ...
    printf("  - Indexed HathiTrust Sections: %u Sections (§ 259 to § 284)\n", ch8_metrics.indexed_section_count);
    printf("  - Indexed Paragraph Blocks:   %u Paragraphs\n", ch8_metrics.indexed_paragraph_count);
    ...
    printf("[DIGITIZED HATHITRUST LATIN TEXT PAYLOAD - CAPUT VIII]\n");
    printf("%s\n\n", ocr_text_buffer);

    printf("================================================================================\n");
    printf(" [PROOFS SUCCESSFUL] HathiTrust Volume 1 Chapter 8 Full-Text Latin OCR Engine sound.\n");
    printf("================================================================================\n");
